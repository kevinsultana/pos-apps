...
export default function MasterPaymentEdit({ navigation, route }) {
  const { payment, onUpdate, onDelete } = route.params;
    ...
    <AppLayout navigation={navigation} route={route}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Edit Jenis Pembayaran</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.deleteBtn} onPress={handleDelete}>
            ...
            <Text style={styles.deleteText}>Hapus Jenis Pembayaran</Text>
          </TouchableOpacity>
        </View>
      </View>
    </AppLayout>
