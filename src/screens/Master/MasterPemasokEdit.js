...
export default function MasterPemasokEdit({ navigation, route }) {
  const { supplier, onUpdate, onDelete } = route.params;
  ...
  const handleSave = () => {
    if (!canSave) return;
    onUpdate?.({ ...supplier, name: name.trim(), phone });
    if (Platform.OS === 'android') {
      ToastAndroid.show('Pemasok berhasil diperbarui', ToastAndroid.SHORT);
    }
    navigation.goBack();
  };
  ...
  const handleDelete = () => {
    ...
    if (Platform.OS === 'android') {
      ToastAndroid.show('Pemasok berhasil dihapus', ToastAndroid.SHORT);
    }
    navigation.goBack();
  };
    ...
    <AppLayout navigation={navigation} route={route}>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Edit Pemasok</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.deleteBtn} onPress={handleDelete}>
            ...
            <Text style={styles.deleteText}>Hapus Pemasok</Text>
          </TouchableOpacity>
        </View>
      </View>
    </AppLayout>
